...
export default function EnArticlePage({ params }) {
  ...
  // For the body: if no English content, show a summary box then the original Arabic article
  const hasEnContent = false; // full EN translation not generated yet
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#f8fafc", padding: "0 0 60px", direction: "ltr" }}>
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "28px 24px 0" }}>
        <Link href={leagueHref} style={{ color: "#6d28d9", fontWeight: 700, textDecoration: "none", fontSize: "14px" }}>
          ← Back
        </Link>
        ...
        {/* Article body: original Arabic content displayed clearly */}
        <div style={{
        ...
        {article.faq?.length > 0 && (
          <section style={{ marginTop: "28px" }}>
            <h2 style={{ fontSize: "20px", fontWeight: 800, marginBottom: "14px" }}>Frequently Asked Questions</h2>
