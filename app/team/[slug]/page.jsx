...
const teamsData = {
  ...
  "bayern-munich": {
    ...
    titles: [
      "البوندسليغا: 33 لقباً (سجل قياسي ألماني)",
  ...
  "bayer-leverkusen": {
    ...
    history: [
      "باير ليفركوزن عُرف تاريخياً بالقرب من الألقاب دون الفوز بها، مما أكسبه لقب 'نيفركوزن'، إلا أن حقبة تشابي ألونسو غيّرت هذه الصورة كلياً.",
    ...
    staff: ["تشابي ألونسو — المدرب الرئيسي", "جهاز فني مساعد", "فيمان أورسي — المدير الرياضي", "طاقم طبي"],
  ...
  "inter-milan": {
    ...
    staff: ["سيمون إنزاغي — المدرب الرئيسي", "جهاز فني محترف", "غيوسيبي ماروتا — الرئيس التنفيذي", "طاقم طبي وبدني"],
    players: ["يان سومير", "لوتارو مارتينيز", "نيقولو باريلا", "سيمون إنزاغي", "آلكسيس سانشيز", "هيزيتان تشالهانوغلو"],
  ...
  "al-hilal": {
    ...
    history: [
      ...
      "شكّل الهلال في السنوات الأخيرة منظومة نجوم عالميين أبرزهم نيمار وملاك رييز، مع استمرار الدعم اللامتناهي من قبل الإدارة."
    ],
    titles: [
    ...
    staff: ["ماتياس فيلمان — المدرب الرئيسي", "جهاز فني متكامل", "مدير رياضي محترف", "طاقم طبي وبدني"],
    players: ["نيمار", "ملاك رييز", "غوسيبي رييسينكو", "أودييل مالكوم", "أنغوس هينريكسن", "سامي الجابر (أسطورة)"],
  ...
  "al-nassr": {
    ...
    staff: ["ستيفانو بيولي — المدرب الرئيسي", "جهاز فني متكامل", "إدارة رياضية محترفة", "طاقم طبي وبدني"],
