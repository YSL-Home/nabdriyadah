...
const leagueConfig = {
  ...
  "world-cup":        { title: "Coupe du Monde FIFA",       logo: "https://media.api-sports.io/football/leagues/1.png",   theme: { heroFrom: "#1a1a2e", heroTo: "#c9a84c", primary: "#b45309", primarySoft: "#fffbeb", border: "#fde68a" } },
  ...
  "afcon":            { title: "CAN — Coupe d'Afrique",     logo: "https://media.api-sports.io/football/leagues/6.png",   theme: { heroFrom: "#78350f", heroTo: "#f59e0b", primary: "#d97706", primarySoft: "#fffbeb", border: "#fde68a" } },
  "caf-champions-league": { title: "Ligue des Champions CAF", logo: "https://media.api-sports.io/football/leagues/20.png", theme: { heroFrom: "#78350f", heroTo: "#d97706", primary: "#b45309", primarySoft: "#fffbeb", border: "#fde68a" } },
  "club-world-cup":   { title: "Coupe du Monde des Clubs",  logo: "https://media.api-sports.io/football/leagues/15.png",  theme: { heroFrom: "#1a1a2e", heroTo: "#4f46e5", primary: "#4f46e5", primarySoft: "#eef2ff", border: "#c7d2fe" } },
  "botola-ma":        { title: "Botola Pro Inwi (Maroc)",   logo: "https://media.api-sports.io/football/leagues/200.png", theme: { heroFrom: "#14532d", heroTo: "#16a34a", primary: "#16a34a", primarySoft: "#f0fdf4", border: "#bbf7d0" } },
  "ligue-pro-dz":     { title: "Ligue Professionnelle (Algérie)", logo: "https://media.api-sports.io/football/leagues/197.png", theme: { heroFrom: "#14532d", heroTo: "#dc2626", primary: "#b91c1c", primarySoft: "#fef2f2", border: "#fecaca" } },
  "prem-egy":         { title: "Premiership Égyptienne",   logo: "https://media.api-sports.io/football/leagues/233.png", theme: { heroFrom: "#7f1d1d", heroTo: "#dc2626", primary: "#b91c1c", primarySoft: "#fef2f2", border: "#fecaca" } },
  "ligue-pro-tn":     { title: "Ligue Pro (Tunisie)",       logo: "https://media.api-sports.io/football/leagues/202.png", theme: { heroFrom: "#7f1d1d", heroTo: "#dc2626", primary: "#b91c1c", primarySoft: "#fef2f2", border: "#fecaca" } },
  ...
  "futsal-monde":     { title: "Coupe du Monde de Futsal",  logo: "https://media.api-sports.io/football/leagues/1.png",   theme: { heroFrom: "#1e3a8a", heroTo: "#3b82f6", primary: "#2563eb", primarySoft: "#eff6ff", border: "#bfdbfe" } },
  "f1":               { title: "Formule 1",                 logo: "https://media.api-sports.io/formula-1/logo.png",       theme: { heroFrom: "#1a1a1a", heroTo: "#dc2626", primary: "#dc2626", primarySoft: "#fef2f2", border: "#fecaca" } },
